...
namespace vr {
	...
	std::vector<char> VrPipeline::readFile(const std::string& filename) {
	...
	void VrPipeline::createGraphicsPipeline(
		...
		// Combine viewport & scissor info into viewportInfo variable
	...
	PipelineConfigInfo VrPipeline::defaultPipelineConfigInfo(uint32_t width, uint32_t height) {
		...
		// The viewport tells our pipeline how we want to transform the gl_position values to the output image (in pixels)
		...
		// Anything outside of the rectangle starting at offset going to extent will be cut
